...
var QRCodeReader = /** @class */ (function () {
    ...
    QRCodeReader.prototype.tryReadVersion = function (matrix) {
        try {
            var parser = new BitMatrixParser(matrix);
    ...
    QRCodeReader.prototype.decode = function (image, hints) {
        ...
        var result = new Result(decoderResult.getText(), decoderResult.getRawBytes(), undefined, points, BarcodeFormat.QR_CODE, undefined, versionNumber);
