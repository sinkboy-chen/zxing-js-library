...
var FormatException_1 = require("../FormatException"); // adjust path if needed
var BitMatrixParser_1 = require("./decoder/BitMatrixParser"); // adjust path if needed
...
var QRCodeReader = /** @class */ (function () {
    ...
    // }
    QRCodeReader.prototype.tryReadVersion = function (matrix) {
        try {
            var parser = new BitMatrixParser_1.default(matrix);
            var version = parser.readVersion();
            return version.getVersionNumber();
        }
        catch (e) {
            if (e instanceof FormatException_1.default) {
    ...
    QRCodeReader.prototype.decode = function (image, hints) {
        ...
        if (hints !== undefined && hints !== null && undefined !== hints.get(DecodeHintType_1.default.PURE_BARCODE)) {
            ...
            var bits = detectorResult.getBits();
            decoderResult = this.decoder.decodeBitMatrix(bits, hints);
        ...
        var result = new Result_1.default(decoderResult.getText(), decoderResult.getRawBytes(), undefined, points, BarcodeFormat_1.default.QR_CODE, undefined, versionNumber);
