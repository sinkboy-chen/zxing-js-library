...
var CurrentParsingState_1 = require("./CurrentParsingState");
...
var GeneralAppIdDecoder = /** @class */ (function () {
    function GeneralAppIdDecoder(information) {
        this.current = new CurrentParsingState_1.default();
    ...
    GeneralAppIdDecoder.prototype.parseNumericBlock = function () {
        while (this.isStillNumeric(this.current.getPosition())) {
            ...
            if (numeric.isFirstDigitFNC1()) {
                ...
                return new BlockParsedResult_1.default(information, true);
            }
        ...
        return new BlockParsedResult_1.default();
    };
    ...
    GeneralAppIdDecoder.prototype.parseAlphaBlock = function () {
        while (this.isStillAlpha(this.current.getPosition())) {
            ...
            if (alpha.isFNC1()) {
                var information = new DecodedInformation_1.default(this.current.getPosition(), this.buffer.toString());
                return new BlockParsedResult_1.default(information, true); // end of the char block
            }
    ...
    GeneralAppIdDecoder.prototype.decodeIsoIec646 = function (pos) {
        ...
        if (fiveBitValue >= 5 && fiveBitValue < 15) {
            return new DecodedChar_1.default(pos + 5, String.fromCharCode('0'.charCodeAt(0) + fiveBitValue - 5));
        }
        var sevenBitValue = this.extractNumericValueFromBitArray(pos, 7);
        if (sevenBitValue >= 64 && sevenBitValue < 90) {
            return new DecodedChar_1.default(pos + 7, String.fromCharCode(sevenBitValue + 1));
        }
        if (sevenBitValue >= 90 && sevenBitValue < 116) {
            return new DecodedChar_1.default(pos + 7, String.fromCharCode(sevenBitValue + 7));
        }
        var eightBitValue = this.extractNumericValueFromBitArray(pos, 8);
        var c;
    ...
    GeneralAppIdDecoder.prototype.decodeAlphanumeric = function (pos) {
        ...
        if (sixBitValue >= 32 && sixBitValue < 58) {
            return new DecodedChar_1.default(pos + 6, String.fromCharCode((sixBitValue + 33)));
        }
        var c;
        switch (sixBitValue) {
            case 58:
